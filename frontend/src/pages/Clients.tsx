        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {clients.map((client, index) => (
              <div key={index} className="bg-white p-14 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 duration-300 border border-gray-300">
                
                {/* Icon Box */}
                <div className={`w-21 h-20 rounded-full flex items-center justify-center mb-6 ${client.color}`}>
